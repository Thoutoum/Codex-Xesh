...
Codex Xesh est une application web légère et rapide conçue pour les joueurs de *Star Wars: Légion*. Elle permet de rechercher les mot-clés (EN ou FR) et leurs définitions (FR).

**[Accéder à l'application Codex Xesh](https://thoutoum.github.io/Codex-Xesh/)**
...
1. Ouvrez [le lien de l'application](https://thoutoum.github.io/Codex-Xesh/) sur le navigateur de votre smartphone (Safari pour iOS, Chrome pour Android).
2. Ouvrez le menu des options de votre navigateur (le bouton "Partager" sur iOS, ou les trois petits points verticaux sur Android).
...
* **Par e-mail :** [thoutoum@gmail.com](mailto:thoutoum@gmail.com)
